...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-red from-background-primary via-gray-950 to-background-secondary flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-100 h-100 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full mb-8 animate-pulse-orange">
            <Logo size={80} />
          </div>
        </div>
        ...
        <form
          ...
          className="p-8 space-y-6 animate-slide-in-right"
        >
          <h2 className="text-2xl font-bold text-center text-white my-12">Connexion</h2>
